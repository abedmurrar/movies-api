  ...
  jQuery.ajax({
    ...
    error() {
      bootbox.alert({
        ...
        title: "Oooops",
        message:
          "Something went wrong. Refresh the page or visit us later. Thank u"
      });
    }
  });
}
...
function displayMovie(data) {
  ...
  /* Add the buttons */
  const td = $("<td></td>");
  const buttonDeleteHtml = $(
    '<button type="button" onclick="deleteMovie(this)" class="btn btn-danger"><i class="fa fa-minus"></i></button>'
  );
  const buttonEditHtml = $(
    '<button type="button" onclick="updateMovie(this)" class="btn btn-primary flex-center"><i class="fa fa-edit"></i></button>'
  );
